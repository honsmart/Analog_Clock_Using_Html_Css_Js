// https://www.youtube.com/@CodeWithHonsmart
// TikTok @CodeWithHonsmart 
// www.codewithhonsmart.com 
...
function toggleTick() {
    ...
    if (ticking) {
        ...
        soundtoggle.querySelector('.sr-only').innerText = 'sound toggle, currently sound is on';
    } else {
        soundtoggle.setAttribute('aria-pressed', 'false');
        soundtoggle.querySelector('.sr-only').innerText = 'sound toggle, currently sound is off';
    }
}
